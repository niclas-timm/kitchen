    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Wiederherstellungscodes ermöglichen den Zugang, falls Sie Ihr
                    2FA-Gerät verlieren. Bewahren Sie sie in einem sicheren Passwort-Manager auf.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="flex flex-col gap-3 select-none sm:flex-row sm:items-center sm:justify-between">
                    ...
                    >
                        <RecoveryCodeIconComponent
                            ...
                            aria-hidden="true"
                        />
                        Wiederherstellungscodes {codesAreVisible ? 'verbergen' : 'anzeigen'}
                    </Button>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        und wird danach entfernt. Wenn Sie mehr benötigen,
